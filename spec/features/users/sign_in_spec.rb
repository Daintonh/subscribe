require 'spec_helper'
require "subscribe/testing_support/subdomain_helpers"
require "subscribe/testing_support/factories/account_factory"

feature 'User sign in' do
  extend Subscribe::TestingSupport::SubdomainHelpers
  ...
  within_account_subdomain do
    ...
    scenario "attempts sign in with an invalid password and fails" do
      visit subscribe.root_url(:subdomain => account.subdomain)
      page.current_url.should == sign_in_url
